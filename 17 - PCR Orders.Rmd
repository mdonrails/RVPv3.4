...
```{r}
library(readxl)
pcr.r <- read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/Documents/EM Research/Data Analysis/RVPv3.4/Excel/RVP_PCR_All.xlsx", 
...
remove duplicates
```{r}
pcr.flu.clean <- pcr.flu.tidy %>% arrange(FIN, OrderComplete_DateTime, FluOverall) #sort 
...
export
```{r}
saveRDS(pcr.flu.spread, file = "dfs/pcr.flu.overall.Rda")
```
